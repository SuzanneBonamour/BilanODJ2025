...
plot_verdier_ODJ_STOC = ggplot() +
                          ...
                          theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1),
                                         ...
                                         legend.position = "top",
                                         legend.justification = "left") ; plot_verdier_ODJ_STOC 

# simplifié 

plot_verdier_ODJ_STOC_2 = ggplot() +
                          geom_hline(yintercept = yRef, col = "gray", linetype = "dashed", linewidth = 1.01) +
                          # ODJ
                          geom_line(data = dataPlot[dataPlot$group == "LT",], aes(x = year, y = estimate),
                                             alpha = 1, linewidth = 1.5, color = "black") +
                          annotate(geom = "text", label = "*", color = "black", size = 5, 
                                   x = xSignLT-0.25, y = ySignLT) +
                          annotate(geom = "text", label = paste0(dataLT_sp$perc, "%"), color = "darkgrey", size = 5,
                                   x = xGrLT+0.25, y = yGrLT) +
                          # STOC
                          geom_line(data = dataPlot_STOC[dataPlot_STOC$group == "LT",], aes(x = year, y = estimate),
                                             alpha = 1, linewidth = 1.5, color = "darkgreen") +
                          annotate(geom = "text", label = "***", color = "darkgreen", size = 5, 
                                   x = xSignLT_STOC-0.25, y = ySignLT_STOC) +
                          annotate(geom = "text", label = paste0(dataLT_sp_STOC$perc, "%"), color = "darkgreen", size = 5,
                                   x = xGrLT_STOC+0.25, y = yGrLT_STOC) +
                          ggtitle(sp) +
                          scale_x_continuous(breaks = yearValues, limits = c(dataLT_sp$minYear - 1, dataLT_sp$maxYear +1)) +
                          ...
                          theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1),
                                         ...
                                         panel.grid.minor = element_blank(),
                                         legend.position = "top",
                                         legend.justification = "left") ; plot_verdier_ODJ_STOC_2 
